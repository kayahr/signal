...
describe("index", () => {
    it("exports relevant types and functions and nothing more", () => {
        ...
        ((): CreateSignalOptions<number> => ((0 as exports.CreateSignalOptions<number>)))();
        ((): CreateMemoOptions<number> => ((0 as exports.CreateMemoOptions<number>)))();
        ((): CreateEffectOptions<number> => ((0 as exports.CreateEffectOptions<number>)))();
        ((): CreateResourceOptions<number> => ((0 as exports.CreateResourceOptions<number>)))();
